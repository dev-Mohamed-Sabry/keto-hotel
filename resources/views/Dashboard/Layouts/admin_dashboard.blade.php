...
<head>
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="{{ asset('assets/Admin_Dashboard/vendor/bootstrap/css/bootstrap.min.css') }}">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="{{ asset('assets/Admin_Dashboard/vendor/font-awesome/css/font-awesome.min.css') }}">
    <!-- Custom Font Icons CSS-->
    <link rel="stylesheet" href="{{ asset('assets/Admin_Dashboard/css/font.css') }}">
    <!-- Google fonts - Muli-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Muli:300,400,700">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('assets/Admin_Dashboard/css/style.default.css') }}" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{ asset('assets/Admin_Dashboard/css/custom.css') }}">
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('assets/Website/images/logo.png') }}">
...
<body>
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    <!-- Navbar Header--><a href="" class="navbar-brand">
                        <div class="brand-text bra{{ route('admin.dashboard') }}nd-big visible text-uppercase">
                            <strong class="text-primary">
                                <img src="{{ asset('assets/Website/images/logo.png') }}" alt="LOGO" class="w-3/4">
                            </strong>
                            {{-- <strong>Admin</strong> --}}
                        </div>
                ...
                <div class="right-menu list-inline no-margin-bottom d-flex">
                    ...
                    <div class="list-inline-item px-3">
                        <a href="{{ route('profile.show') }}" class="nav-link " alt="Profile">
                            Proflie
                        </a>
                    </div>
    ...
    <script src="{{ asset('assets/Admin_Dashboard/vendor/popper.js/popper.min.js') }}"> </script>
    <script src="{{ asset('assets/Admin_Dashboard/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/Admin_Dashboard/vendor/jquery.cookie/jquery.cookie.js') }}"> </script>
    <script src="{{ asset('assets/Admin_Dashboard/vendor/chart.js/Chart.min.js') }}"></script>
    <script src="{{ asset('assets/Website/js/jquery.validate.js') }}"></script>
    <script src="{{ asset('assets/Admin_Dashboard/js/charts-home.js') }}"></script>
    <script src="{{ asset('assets/Admin_Dashboard/js/front.js') }}"></script>
