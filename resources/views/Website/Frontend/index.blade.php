        ...
        <div id="myCarousel" class="carousel slide banner" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="first-slide" src="{{ asset('assets/Website/images/banner1.jpg') }}" alt="First slide">
                    <div class="container">
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="second-slide" src="{{ asset('assets/Website/images/banner2.jpg') }}" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="third-slide" src="{{ asset('assets/Website/images/banner3.jpg') }}" alt="Third slide">
                </div>
            </div>
                        ...
                        <div class="book_room">
                            ...
                            <form class="book_now">
                                <div class="row">
                                    <div class="col-md-12">
                                        <span>Arrival</span>
                                        <img class="date_cua" src="{{ asset('assets/Website/images/date.png') }}">
    ...
    <div class="about">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="about_img">
                        <figure><img src="{{asset('assets/Website/images/about.png')}}" alt="#" /></figure>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div id="serv_hover" class="room">
                        <div class="room_img">
                            <figure><img src="{{asset('assets/Website/images/room1.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                            <h3>Bed Room</h3>
                ...
                <div class="col-md-4 col-sm-6">
                    <div id="serv_hover" class="room">
                        <div class="room_img">
                            <figure><img src="{{asset('assets/Website/images/room2.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                            <h3>Bed Room</h3>
                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there </p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div id="serv_hover" class="room">
                        <div class="room_img">
                            <figure><img src="{{asset('assets/Website/images/room3.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                            <h3>Bed Room</h3>
                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there </p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div id="serv_hover" class="room">
                        <div class="room_img">
                            <figure><img src="{{asset('assets/Website/images/room4.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                            <h3>Bed Room</h3>
                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there </p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div id="serv_hover" class="room">
                        <div class="room_img">
                            <figure><img src="{{asset('assets/Website/images/room5.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                            <h3>Bed Room</h3>
                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there </p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div id="serv_hover" class="room">
                        <div class="room_img">
                            <figure><img src="{{asset('assets/Website/images/room6.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="bed_room">
                            <h3>Bed Room</h3>
                            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there </p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="blog_box">
                        <div class="blog_img">
                            <figure><img src="{{asset('assets/Website/images/blog1.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="blog_room">
                            <h3>Bed Room</h3>
                ...
                <div class="col-md-4">
                    <div class="blog_box">
                        <div class="blog_img">
                            <figure><img src="{{asset('assets/Website/images/blog2.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="blog_room">
                            <h3>Bed Room</h3>
                            <span>The standard chunk </span>
                ...
                <div class="col-md-4">
                    <div class="blog_box">
                        <div class="blog_img">
                            <figure><img src="{{asset('assets/Website/images/blog3.jpg')}}" alt="#" /></figure>
                        </div>
                        <div class="blog_room">
                            <h3>Bed Room</h3>
                            <span>The standard chunk </span>
